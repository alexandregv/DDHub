    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args){
    	if(args.length == 0){
            ...
            if(target.isOnline()){
                ...
                if(sender instanceof Player) sender.sendMessage(ChatColor.YELLOW + args[0] + ChatColor.RED + " n'est pas connect�.");
                else ChatUtils.sendMsg(target, ChatColor.YELLOW + args[0] + ChatColor.RED + " n'est pas connect�.");
            }
        }
